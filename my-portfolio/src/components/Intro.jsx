    ...
    return (
        ...
        text-center pt-20 pb-6">
            ...
            <p className="text-base md:text-x1 mb-3 font-medium">That's me - a prospective Software Engineer!
                ...
                I hope that it's fun for you to see, since being an IT student <i class="fa-solid fa-terminal"></i>  keeps you busy all the time, this website is still a work in progress. 
                ...
                Of course, life isn’t all about code! I do also find time for leisure activities, like travelling <i className="fa-solid fa-earth-americas"></i>, watching tv shows and movies, reading, cooking(and eating, I belive I live to eat, not the other way around!);
            </p>
            <p className="text-sm max-w-xl mb-6 font-bold"> Below you can see some of the projects I have worked on. 
                By clicking on them you will be taken to the corresponding GitHub repositories. Since completing these projects, I’ve worked on more advanced projects and continue to improve my skills.
                I know these projects are far from perfect, 
                still, I want to show my journey and growth. 
                </p>
        </div>
    )
}
